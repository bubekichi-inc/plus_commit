            ...
            <main className="min-h-screen pt-20">
                <section className="py-24 border-b border-slate-800">
                    <div className="container mx-auto px-4">
                        <div className="text-blue-400 font-medium mb-2 tracking-wider">CONTACT</div>
                        ...
                        <div className="grid md:grid-cols-3 gap-12">
                            <div className="md:col-span-2">
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full bg-slate-900 border border-slate-800 px-4 py-3 text-slate-100 focus:outline-none focus:border-blue-500 transition-colors"
                                                placeholder="株式会社〇〇"
                                            />
                                        </div>
                                        <div>
                                            <label className="block text-sm font-medium text-slate-400 mb-2">
                                                ご担当者名 <span className="text-blue-400">*</span>
                                            </label>
                                            <input
                                                type="text"
                                                required
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div>
                                            <label className="block text-sm font-medium text-slate-400 mb-2">
                                                ご検討中のサービス <span className="text-blue-400">*</span>
                                            </label>
                                            <select
                                                required
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-slate-400 mb-2">
                                            プロジェクトの詳細 <span className="text-blue-400">*</span>
                                        </label>
                                        <textarea
                                            required
                                            rows={6}
                                            ...
                                            className="w-full bg-slate-900 border border-slate-800 px-4 py-3 text-slate-100 focus:outline-none focus:border-blue-500 transition-colors resize-none"
                                    ...
                                    <Button 
                                        type="submit"
                                        size="lg"
                                        className="bg-blue-600 hover:bg-blue-500 text-white font-bold px-12"
                                    >
                                        送信する
                                    </Button>
                                </form>
                            ...
                            <div className="space-y-6">
                                <div className="bg-slate-900 border border-slate-800 p-6">
                                    <h3 className="text-white font-bold mb-4 border-l-2 border-blue-500 pl-3">
                                        お問い合わせの流れ
                                    </h3>
                                ...
                                <div className="bg-blue-950/50 border border-blue-500/30 p-6">
