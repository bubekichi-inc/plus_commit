                ...
                <div className="max-w-4xl mx-auto">
                    <div className="grid gap-16">
                        ...
                        <motion.div
                            ...
                            className="relative"
                        >
                            <div className="absolute -left-4 top-0 w-1 h-full bg-gradient-to-b from-primary-500 to-transparent" />
                            <div className="pl-8">
                                <span className="text-primary-600/70 text-xs font-bold tracking-widest uppercase">Mission</span>
                                <h2 className="text-3xl md:text-4xl font-black text-zinc-900 mt-2 mb-6">
                                    「1億総エンジニア社会」を創る
                                </h2>
                        ...
                        >
                            ...
                            <div className="pl-8">
                                <span className="text-accent/70 text-xs font-bold tracking-widest uppercase">Vision</span>
                                <h2 className="text-3xl md:text-4xl font-black text-zinc-900 mt-2 mb-6">
                                    デジタル変革の最高のパートナー
                                </h2>
                                <p className="text-zinc-600 leading-relaxed text-lg">
                        ...
                        <motion.div
                            ...
                            className="relative"
                        >
                            <div className="absolute -left-4 top-0 w-1 h-full bg-gradient-to-b from-primary-600 to-transparent" />
                            <div className="pl-8">
                                <span className="text-primary-600/70 text-xs font-bold tracking-widest uppercase">Values</span>
                                <h2 className="text-3xl md:text-4xl font-black text-zinc-900 mt-2 mb-6">
                                    大切にしている価値観
                                </h2>
                                <div className="grid md:grid-cols-2 gap-6 mt-8">
                                    {[
                                        ...
                                        <div key={value.title} className="p-6 bg-white border border-zinc-200 rounded-xl shadow-sm">
                                            <h3 className="text-zinc-900 font-bold text-lg mb-2">{value.title}</h3>
                    ...
                    >
                        <div className="grid gap-6">
                            {[
                                ...
                                <div key={item.label} className="flex flex-col md:flex-row md:items-center border-b border-zinc-200 pb-4 last:border-0 last:pb-0">
                                    <span className="text-zinc-500 text-sm w-32 shrink-0 mb-1 md:mb-0">{item.label}</span>
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <Link
                            ...
                            className="group p-8 bg-white border border-zinc-200 rounded-2xl hover:border-primary-500 hover:bg-primary-50/30 transition-all shadow-sm"
                        >
                            <span className="text-zinc-500 text-sm">Explore</span>
                            <h3 className="text-xl font-bold text-zinc-900 mt-2 group-hover:text-primary-600 transition-colors flex items-center gap-2">
                                募集職種
                                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                            </h3>
