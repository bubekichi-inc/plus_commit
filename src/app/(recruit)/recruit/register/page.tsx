...
export default function RecruitRegisterPage() {
    ...
    const { user, signUp, signInWithOAuth, loading, isConfigured } = useAuth()
            ...
            <div className="min-h-screen flex items-center justify-center bg-[#0a0a0a] px-4 py-12">
                <div className="w-full max-w-md">
                    <div className="bg-[#111] border border-white/10 rounded-2xl p-8 text-center">
                        ...
                        <h1 className="text-2xl font-bold text-white mb-4">登録完了</h1>
                        ...
                        <Link href="/recruit/login">
                            <Button className="w-full bg-emerald-500 hover:bg-emerald-400 text-black font-bold py-6 rounded-lg">
                                ログインページへ
                            </Button>
                        </Link>
                    </div>
            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-[#111] border border-white/10 rounded-2xl p-8">
                    ...
                    <div className="text-center mb-8">
                        ...
                        />
                        <h1 className="text-2xl font-bold text-white mb-2">会員登録</h1>
                    ...
                    <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-4 mb-6">
                        <p className="text-emerald-400 text-sm font-bold mb-2">会員特典</p>
                    ...
                    <div className="space-y-3">
                        ...
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-3 bg-[#24292e] hover:bg-[#2f363d] text-white font-medium py-3 rounded-lg transition-colors"
                        >
                    ...
                    <p className="mt-8 text-center text-white/50 text-sm">
                        すでにアカウントをお持ちですか？{" "}
                        <Link href="/recruit/login" className="text-emerald-400 hover:text-emerald-300 font-medium transition-colors">
                            ログイン
                        </Link>
                    </p>
                </div>
