...
export function ShareButtons({ title, id, layout = "sidebar" }: ShareButtonsProps) {
    ...
    if (layout === "sidebar") {
        return (
            <div className="sticky top-28">
                <p className="text-xs text-slate-500 mb-4 font-bold tracking-wider">SHARE</p>
                <div className="flex flex-col gap-2">
                    ...
                    <a
                        ...
                        className="flex items-center justify-center w-10 h-10 bg-slate-800 hover:bg-slate-700 border border-slate-700 transition-colors text-white"
                        title="Xでシェア"
                    >
                    ...
                    <button
                        ...
                        className="flex items-center justify-center w-10 h-10 bg-slate-800 hover:bg-slate-700 border border-slate-700 transition-colors text-white relative group"
                        title="Slack用にコピー"
                    >
                        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        {copied === "slack" && (
                            <span className="absolute left-12 bg-slate-700 text-white text-xs px-2 py-1 whitespace-nowrap">
                                コピーしました!
                            </span>
                        )}
                    </button>
                    ...
                    <button
                        ...
                        className="flex items-center justify-center w-10 h-10 bg-slate-800 hover:bg-slate-700 border border-slate-700 transition-colors text-white relative"
                        title="Chatwork用にコピー"
                    >
                        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
    ...
    return (
        <div className="flex flex-wrap gap-3">
            ...
            >
                ...
                <span>{copied === "slack" ? "コピーしました!" : "Slack"}</span>
            </button>
            ...
            >
                ...
                <span>{copied === "chatwork" ? "コピーしました!" : "Chatwork"}</span>
            </button>
